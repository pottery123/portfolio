...
function Aprender() {
  ...
  // useEffect(() => {
  //   const ele = problemRef.current;
  //   if (!ele) {
  //     return;
  //   }
  //   const observer = new IntersectionObserver(([entry]) => {
  //     setProblemVisiable(entry.isIntersecting);
  //   });
  ...
  return (
    <div ref={pageTop} className="relative w-auto  font-Quicksand">
      <div>
        <div className=" md:flex justify-around bg-aprenderPink w-auto  relative block z-20 ">
          <img
      ...
      <div>
        ...
        <div className="scroll-m-52" ref={problem}>
