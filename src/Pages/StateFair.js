...
function StateFair() {
  ...
  return (
    <div className="relative w-auto overflow-hidden">
      ...
      <div className="bg-white font-bold w-full drop-shadow-sm flex justify-between  top-0 z-20  relative overflow-scroll">
        <button
          onClick={() => {
      ...
      <div className={` h-0  ${openCaseStudy && "  h-full"} `}>
        {showTheProblems && (
          <div className="md:p-40 lg:p-40 mx-8 my-4 ">
            ...
            <div className="">
              <div className="font-Quicksand md:text-xl lg:text-xl">
