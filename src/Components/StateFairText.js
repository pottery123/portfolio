const description1 = (
  <div className="max-w-lgs">
    ...
    <div className="">
      ...
      users never read the whole text.
    </div>
...
const description3 = (
  <div className=" max-w-lgs">
    ...
    <div className="">
      ...
      user can focus on the method that is more intuitive.
    </div>
    <div className="pt-5 italic">
      ...
      the interface works. This helps to build an experience that feels
...
const description4 = (
  <div className=" max-w-lgs">
    ...
    <div className="">
      ...
      goes straight to the seat map even if it was selected accidentally. This
    ...
    <div className="pt-5 italic">
      ...
      task at hand.efit from UI controls that allow people to go back to the
      previous state of the system(e.g., Back buttons to return to previous
...
const description5 = (
  <div className=" max-w-lgs">
    ...
    <div className="">
      ...
      The prices for all seats should be visible.
    </div>
    <div className="pt-5 italic">
...
const description7 = (
  <div className=" max-w-lgs">
    ...
    <div className="">
      ...
      This information is redundant and it can cause users to be confused. It
...
const description8 = (
  <div className=" max-w-lgs">
    ...
    <div className="">
      ...
      behind a button. Instead they should be displayed where users can easily
      view them.
    </div>
    <div className="pt-5 italic">
...
const description9 = (
  <div className=" max-w-lgs">
    ...
    <div className="">
      ...
      buttons was beyond the user's mental model of how to increase and decrease
      the screen size. The buttons need to be removed.
    </div>
    <div className="pt-5 italic">
      "A comprehensible system should never confuse users by using different
      words, visuals, or actions for the same concepts." --Nielsen 
